...
import { idlFactory } from './tracify.did.js';
export { idlFactory } from './tracify.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TRACIFY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tracify.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tracify canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tracify.did.js")._SERVICE>}
 */
export const tracify = createActor(canisterId);
